		...
		<div class="content-wrapper">
			...
			<div class="col-xs-12 content content-max" style="margin-bottom:15px;">
				...
				<div class="container-fluid">
					...
					<div class="col-xs-12 col-sm-6">
						<div class="container-fluid">
							<img src="includes/getImage.php?_=<?php echo $ADK_CORRESPONDENT->photoid; ?>" class="img-responsive imghover" alt="Photo - <?php echo $ADK_CORRESPONDENT->name; ?>" title="<?php echo $ADK_CORRESPONDENT->name; ?>" />
						</div>
					</div>

<?php
	...
	function sendNewHikerEmail($ADK_USER, $ADK_CORRESPONDENT) {
		...
		$htmlmessage .= "<b>".$ADK_USER->username."</b><br><br>";
		$htmlmessage .= "Initial Password:<br>";
		$htmlmessage .= "<b>".$ADK_USER->pw."</b><br><br>";

		$htmlmessage .= "<a href=\"$url\">Click here to log in!</a><br><br><br><br>";
	...
	function send46erCompletionEmail($ADK_HIKER) {
		...
		$htmlmessage .= "You may still use this site to log any hikes, upload photos, or message your correspondent.<br>";
		...
		$message .= "You may still use this site to log any hikes, upload photos, or message your correspondent.\r\n";
